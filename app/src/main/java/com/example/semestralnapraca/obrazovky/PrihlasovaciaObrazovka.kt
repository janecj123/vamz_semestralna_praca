...
import data.AplikaciaViewModel

@Preview(showBackground = true)
@Composable
fun PrihlasovaciaObrazovka(aplikaciaViewModel: AplikaciaViewModel = viewModel()) {
       ...
       verticalArrangement = Arrangement.SpaceEvenly,
        ...
        Column() {
            ...
            OutlinedTextField(
                ...
                singleLine = true,
                label = { Text(stringResource(R.string.prihlasovacie_meno_label),
                    color = Color.White) })
            ...
            OutlinedTextField(
                ...
                singleLine = true,
                label = { Text(stringResource(R.string.heslo_label),
                        color = Color.White) })
            Button(onClick = { /*TODO*/ }) {
                    }
        }
